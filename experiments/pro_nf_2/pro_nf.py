...
def train_pro_nf(monitor_every=10):
    ...
    if args.resume:
        ...
        if len(args.image_size) == 1:
            optimizer = checkpoints.restore_checkpoint("./experiments/pro_nf_2/checkpoints/" + dir_name, optimizer)
        else:
            if os.path.exists("./experiments/pro_nf_2/checkpoints/" + dir_name):
                import ipdb;ipdb.set_trace()
                optimizer = checkpoints.restore_checkpoint("./experiments/pro_nf_2/checkpoints/" + dir_name, optimizer)
            else:
                optimizer = restore("./experiments/pro_nf_2/checkpoints/", optimizer)
    ...
    def sample(params, rng, num_samples, epoch, dir_name, gt_image):
        ...
        path = './experiments/pro_nf_2/samples/{}/'.format(dir_name)
    ...
    for e in range(epoch):
        ...
        checkpoints.save_checkpoint("./experiments/pro_nf_2/checkpoints/" + dir_name, optimizer, e, keep=3)
